...
(10~mM Tris pH 8.0, 1 mM EDTA, and 50~mM NaCl) or in ``transcription buffer'' (40 mM HEPES-NaOH pH 7, 50 mM KCl, 10 mM MgCl$_{2}$, 1 mM DTT, 1 mM MEA, BSA: 100 $\mu$g/ml)~\cite{lerner_PNAS_2016}.
...
%Both illumination uniformity and low PDE in the red region of the spectrum 
%can be addressed, further increasing throughput.
...
of acquisition.
Such a throughput is advantageous for real-time kinetic experiments,
...
these measurements are analyzed by dividing the acquisition in short consecutive time windows.
The time resolution, i.e. the smallest usable time window,
depends on the burst rate and the type of information .
