...
The 48-spot setup employs two 12x4-pixels SPAD arrays~\cite{Gulinatti_2013}.
The active area of each pixel is 50~{\micron} with a 500~{\micron} pitch.
The photon detection efficiency (PDE) of these devices has a maximum of 45\%
at around 550~nm\cite{Gulinatti_2013}.
We compare 48-spot smFRET-PAX results with similar measurements obtained
with a state-of-the-art {\usalex} setup.
This setup employs a single-pixel SPAD
