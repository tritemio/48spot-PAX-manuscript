...
macromolecular complexes is important for the understanding of their
...
a population of macromolecular complexes as well as the distance between
specific residues for each state. Recently, several groups used smFRET to
...
triangulation and comparison to existing X-ray crystal structures.
...
confocal volume at a given time[ref], only very slow kinetics could
be measured. Therefore, both static and dynamic measurements of multiple
