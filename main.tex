...
burst search is identical as in figure~\ref{fig:alexhist48all12d}, while
...
Here we provide results obtained with a low-FRET 22d DNA sample.
Fig.~\ref{fig:alexhist48all22d} shows the E-S histograms for the different
channels using $E_{PR}$ (eq.~\ref{eq:Epr} and $S_u$ (eq.~\ref{eq:Su})
as defined. We observe that even though the FRET population has an $S_u$
value $>0.5$ it is still possible to filter bursts and separate
the FRET and D-only populations.
