...
We note the intensity profile tapers off on the lateral pixels, an effect
Due to the Gaussian profile of the excitation beam and to geometrical
aberrations the lateral pixels recive a lower signal than the central ones.
This results in a smaller number of detected single-molecule bursts in
the lateral spots.

Fig.~\ref{fig:phrates_usalex} shows the distribution
of peak photon rates as obtained with the {\usalex} setup.
Comparing Fig.~\ref{fig:pharates48_comp} Panel~A and~\ref{fig:pharates_usalex}
