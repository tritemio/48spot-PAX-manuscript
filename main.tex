...
that a molecule detected in one spot is later detected by a different spot.
However, given size and separation of the PSFs, the probability 
of such an event is quite rate even for nearby spots. In addition,
these events, even if present, will not affect burst analysis, but
they can be potentially detected with cross-correlation 
of photon stream of two spots. However, for the measurement here reported,
no correlation between spot was observed.
