...
The two pattern overlap and centering with respect to the optical axis
is assessed via 2-D Gaussian fitting (Panel C). More details on the alignment
procedure and pattern assessment can be found in appendix~\ref{sec:lcos}.


See appendix~\ref{sec:lcos} for more details.
...
Here we provide additional results obtained with a low-FRET 22d DNA sample.
