...
TE50 buffer was used for all measurements excluding measurements collected for 
Fig.~\ref{fig:alex_mspot_5} and~\ref{fig:alex_sspot_5}. For the comparison of 

where transcription buffer was used to reduce photobleaching.
This measure was taken in order to compare measurement of single sample on both setups. 
