...
multispot measurement are about 22 times larger than in the
...
Raw data transferred from the FPGA is saved in a binary file together with a
text-based metadata file containing measurement details.
