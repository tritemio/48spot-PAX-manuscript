...
In order to illustrate the high-throughput capability of the multispot
...
rate-threshold of 30~kcps and similar burst-size selection.
...
The burst duration histograms show that burst durations are on average
larger in the multi-spot setup, meaning that a larger sample volume is
probed by each spot. Larger PSF volumes
