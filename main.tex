...
% * <michalet@chem.ucla.edu> 2017-06-20T02:03:44.711Z:
% 
% I "closed" most of my comments because I misunderstood what that meant (I thought it was just a matter of collapsing the comment box), so please check all my comments if you haven't addressed them already.
% 
% ^.
...
Compared to our previous multispot setup, the number of spots was increased
six-fold with a corresponding increase in throughput.
While larger SPAD arrays have been fabricated and demonstrated,
they are fabricated using standard high-voltage CMOS processes not designed
for photon detector optimization but instead dense integrated circuit design,
...
Compared to our previous works, a second alternating excitation
laser was incorporated, and the corresponding alignment hurdles solved,
...
\nocite{*}
% * <michalet@chem.ucla.edu> 2017-06-20T02:02:29.558Z:
% 
% The bibliography items need to be edited as I commented on the Progress Report Publication List (and more).
% 
% ^.
