...
The combined use of $E$ and $S$ (either corrected or uncorrected)
...
In Fig.~\ref{fig:phrates48_comp} (Panels C, E), we observe that pixel
at position (1, 7) in the A-SPAD arrays systematically
detects less photons, because of a lower PDE. Furthermore, two pixels in the
D-SPAD arrays had a failure in their active quenching circuit (AQC),
and results for their respective spots are therefore missing.
