...
Its design incorporate a number of technical solutions of potential
interest for other applications, as well as proof of principle demonstration
of its single-molecule FRET measurement capabilities.
We provide a careful comparison of its performance with that
of a standard single-spot (confocal) single-molecule FRET setup.
