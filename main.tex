...
628nm\cite{gulinatti_48-pixel_2013,michalet_silicon_2014}.
About 90\% of the pixels have a dark count rate (DCR) lower than 1 kHz at -15 C,
whereas the worst pixel has a fairly low DCR of about 2.5 kHz.
...
Nonetheless, in this work, even at low FRET values better separation between
...
background-to-noise ratios is significantly higher than in the current 48-spot
setup.
In principle, once populations are separated, one
