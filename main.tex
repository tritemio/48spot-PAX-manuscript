...
Colors indicate different photon streams as follows: green
$D_{ex}D_{em}$, red $D_{ex}A_{em}$, purple $A_{ex}A_{em}$.%
}}
\end{figure}

Fig.~\ref{fig:pharates48_comp} shows the peak photon rate
...
Panel B-E show the mean value (i.e. the decay constant of the exponential tail)
for the different photon streams.
As a comparison, fig.~\ref{fig:pharates_usalex} shows the same distribution
...
\begin{figure}
\includegraphics[width=0.5\columnwidth]{figures/2017-05-23_08_12d_FRET_vs_DO_fitted_Epr-Su_peak_position}
