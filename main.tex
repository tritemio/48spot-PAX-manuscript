...
We demonstrated that the resulting setup indeed allows acquiring
single-molecule data of quality comparable to that of standard single-spot
setups, but with a throughput increased by a factor equal to the number
of spots (equal to the number of SPAD pixels in each detection channel).
...
technique~\cite{doose_periodic_2007} (PAX for short) allows simplifying
the optical setup while maintaining the advantages of {\usalex}, namely
the ability to identify in each single molecule the number of D and A dyes
(stoichiometry) or to identify changes in the fluorescence quantum
yields~\cite{lee_accurate_2005}.
...
buffer (10~mM Tris, bring to pH 8.0 with HCl, 1 mM EDTA, 50~mM NaCl).
...
\begin{figure*}
    ...
    Peak photon rate in each of the 48 spots for a dsDNA sample with
