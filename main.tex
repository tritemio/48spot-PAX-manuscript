...
Compared to a previous multi-spot setup the number of spots was increased from
8 to 48 with a consequent increase in throughput.
Crucially, the addition of a second alternating excitation laser for
allows separating singly- from doubly-labeled species, thus enabling
48-spot measurements for a much wider range of assays.
