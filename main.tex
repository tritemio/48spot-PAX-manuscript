...
\begin{abstract}
Single-molecule FRET allows measuring distances between a donor (D) and
an acceptor (A) fluorophore on the 3-10~nm scale range.
Solution-based single-molecule FRET (smFRET )allows measuring binding-unbinding
...
We show that the acquisition for accurate sub-population identification
